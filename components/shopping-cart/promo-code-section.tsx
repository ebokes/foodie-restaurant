...
interface PromoCodeSectionProps {
  onApplyPromo: (promoCode: string) => Promise<{ success: boolean; message?: string }>;
  appliedPromo: PromoCode | null;
  onRemovePromo: () => void;
}

const PromoCodeSection: React.FC<PromoCodeSectionProps> = ({ onApplyPromo, appliedPromo, onRemovePromo }) => {
