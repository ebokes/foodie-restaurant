        ...
        {restaurants?.map((restaurant) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              {/* Select Button */}
              <button className="w-full bg-linear-to-br from-primary-solid via-grad1 to-grad2 text-primary-foreground py-3 rounded-lg font-body font-medium hover:bg-primary/90 transition-all duration-200 group-hover:scale-[1.02] flex items-center justify-center space-x-2 cursor-pointer">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="space-y-1 text-sm text-muted-foreground">
              ...
              <p>
                • Special dietary requirements can be noted in your reservation
              </p>
            </div>
          </div>
        </div>
