                ...
                return (
                  <button
                    ...
                    className={`p-2 rounded-lg text-sm font-body font-medium transition-all duration-200 ${
                      isSelected
                        ? "bg-linear-to-br from-primary-solid via-grad1 to-grad2 text-primary-foreground shadow-warm"
                        : isDisabled
        ...
        <div>
          ...
          {!selectedDate ? (
            ...
            <div className="text-center py-12">
              <div className="animate-spin w-8 h-8 border-2 border-primary-solid border-t-transparent rounded-full mx-auto mb-4" />
            ...
            <div>
              <div className="text-sm text-muted-foreground mb-3">
                {selectedDate && formatDate(selectedDate)} • {guestCount}{" "}
        ...
        <div className="mt-8 pt-6 border-t border-border">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm text-muted-foreground">
              ...
              {selectedDate && formatDate(selectedDate)} at {selectedTime} for{" "}
              {guestCount} {guestCount === 1 ? "guest" : "guests"}
            </div>

            <button
              onClick={handleContinue}
              className="bg-linear-to-br from-primary-solid via-grad1 to-grad2 text-primary-foreground px-8 py-3 rounded-lg font-body font-medium hover:bg-primary/90 transition-all duration-200 hover:scale-105 flex items-center space-x-2"
            >
