      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              onClick={() =>
                handleInputChange(
                  "guestCount",
                  Math.min(12, formData?.guestCount + 1)
                )
              }
        ...
        <div>
          <Select
            ...
            onChange={(value) =>
              handleInputChange("seatingPreference", String(value))
            }
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <ul className="space-y-1 text-xs">
                <li>
                  &bull; Reservations are held for 15 minutes past the scheduled
                  time
                </li>
                <li>
                  &bull; Large parties may require a credit card to hold the
                  reservation
                </li>
                <li>
                  &bull; Cancellations must be made at least 2 hours in advance
                </li>
                <li>
                  &bull; We&#39;ll send a confirmation email with your
                  reservation details
                </li>
              </ul>
            </div>
        ...
        <div className="pt-6 border-t border-border">
          <Button
            type="submit"
            disabled={loading}
            className="w-full sm:w-auto sm:min-w-[200px] bg-linear-to-br from-primary-solid via-grad1 to-grad2 text-primary-foreground hover:bg-primary/90"
          >
            {loading ? (
              <div className="flex items-center space-x-2">
