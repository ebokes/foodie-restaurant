...
const FooterSection = () => {
  ...
  const socialLinks = [
    { name: "Facebook", icon: "Facebook" as const, url: "#" },
    { name: "Instagram", icon: "Instagram" as const, url: "#" },
    { name: "Twitter", icon: "Twitter" as const, url: "#" },
    { name: "Youtube", icon: "Youtube" as const, url: "#" },
  ];
  ...
  const contactInfo = [
    ...
    },
    {
      icon: "Phone" as const,
      title: "Phone",
      details: ["(555) 123-FOODIES", "(555) 123-7378"],
    },
    {
      icon: "Mail" as const,
      title: "Email",
      details: ["info@foodiesrestaurant.com", "orders@foodiesrestaurant.com"],
    },
    {
      icon: "Clock" as const,
      title: "Hours",
  ...
  return (
    <footer className="bg-[#4c1d0a] text-white">
      {/* Newsletter Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-heading font-bold mb-4">
              ...
              <span className="text-accent">Latest Offers</span>
            </h3>
            <p className="text-secondary-foreground/80 font-body mb-8 max-w-2xl mx-auto">
              Subscribe to our newsletter and be the first to know about new
              menu items, special deals, and exclusive promotions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-4 py-[6] rounded-lg bg-card text-foreground border border-[--border] focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent"
                />
              </div>
              <Button
                variant="default"
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                ...
                <p className="text-sm font-caption text-secondary-foreground/70 -mt-1">
                  Restaurant
                </p>
              </div>
            </div>
            ...
            <p className="text-secondary-foreground/80 font-body mb-6 leading-relaxed">
              ...
              ingredients. Your satisfaction is our commitment.
            </p>
                ...
                <div key={info.title} className="flex space-x-3">
                  ...
                  <div>
                    ...
                    {info.details.map((detail, index) => (
                      <p
                        key={index}
                        className="text-secondary-foreground/80 font-body text-sm"
                      >
                        {detail}
                      </p>
                    ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-secondary-foreground/70 font-body text-sm text-center sm:text-left">
              © {currentYear} Foodies Restaurant. All rights reserved. Made with
              ❤️ for food lovers.
            </p>
            ...
            <div className="flex space-x-6">
              <a
                href="#"
                className="text-secondary-foreground/70 hover:text-accent font-body text-sm transition-colors duration-200"
              >
                Privacy Policy
              </a>
              <a
