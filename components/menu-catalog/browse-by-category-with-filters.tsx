...
interface BrowseByCategoryWithFiltersProps {
  categories: Category[];
...
const BrowseByCategoryWithFilters = ({
  ...
  onFiltersChange,
  className = "",
}: BrowseByCategoryWithFiltersProps) => {
      ...
      <div className="rounded-b-xl">
        ...
        <div
          className={`px-4 pb-3 space-y-2.5 ${
            isFiltersExpanded ? "block" : "hidden md:block"
          }`}
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
            ...
            <Select
              ...
              onChange={(value) => handleFilterChange("dietary", String(value))}
              className="w-full"
            />
            ...
            <Select
              ...
              onChange={(value) =>
                handleFilterChange("priceRange", String(value))
              }
              className="w-full"
            />
