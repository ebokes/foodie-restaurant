              ...
              <div className="p-4 bg-background">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-body font-medium ${getStatusColor(
                        order.status
                      )}`}
                    >
                      <Icon
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex -space-x-2">
                      {order.items.slice(0, 3).map((item, index) => (
                        <div
                          key={index}
                          className="relative w-10 h-10 rounded-lg border-2 border-card overflow-hidden"
                        >
                          <Image
                            src={item.image}
                            alt={item.imageAlt}
                ...
                <div className="border-t border-border p-4 bg-card">
                  <div className="space-y-3">
                    ...
                    {order.deliveryAddress && (
                      <div className="border-t border-border pt-3 mt-3">
                        <h5 className="text-sm font-body font-medium text-foreground mb-1">
                          Delivery Address
                        </h5>
                        <p className="text-sm font-body text-muted-foreground">
