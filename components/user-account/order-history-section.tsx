...
const OrderHistorySection: React.FC<OrderHistorySectionProps> = ({ orders, onReorder, onViewDetails }) => {
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex -space-x-2">
                      {order.items.slice(0, 3).map((item, index) => (
                        <div key={index} className="relative w-10 h-10 rounded-lg border-2 border-card overflow-hidden">
                          <Image
                            src={item.image}
                            alt={item.imageAlt}
                            fill
